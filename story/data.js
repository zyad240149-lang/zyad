...
window.MeaadStory = {
  ...
  chosen: { branch: 'فرع أكتوبر', service: 'تنظيف أسنان', doctor: 'الدكتور أحمد سمير', date: '12 أغسطس', day: 'الثلاثاء', time: '5:00 م', code: 'MA-4821' },
  ...
  notifications: [
    ...
    { id: 'n2', customer: 'خالد منير', channel: 'WhatsApp', kind: 'تذكير 24 ساعة', time: '9:00 ص', status: 'delivered' },
    { id: 'n3', customer: 'داليا رأفت', channel: 'SMS', kind: 'تذكير 24 ساعة', time: '9:00 ص', status: 'sent' },
    { id: 'n4', customer: 'محمد عادل', channel: 'WhatsApp', kind: 'تذكير ساعة', time: '4:30 م', status: 'scheduled' },
    { id: 'n5', customer: 'ليلى فؤاد', channel: 'SMS', kind: 'تذكير 24 ساعة', time: '9:00 ص', status: 'failed' },
  ],
  roster: [
  ...
  roles: [
    { id: 'owner', name: 'مدير العيادة', color: 'var(--teal-700)', permissions: { appointments: 'full', accounting: 'full', staff: 'full', settings: 'full' } },
    { id: 'reception', name: 'موظف استقبال', color: 'var(--blue-500)', permissions: { appointments: 'edit', accounting: 'view', staff: 'none', settings: 'none' } },
    { id: 'accountant', name: 'محاسب', color: 'var(--amber-600)', permissions: { appointments: 'view', accounting: 'full', staff: 'none', settings: 'none' } },
    { id: 'doctor', name: 'طبيب', color: 'var(--green-600)', permissions: { appointments: 'view', accounting: 'none', staff: 'none', settings: 'none' } },
  ],
  permissionModules: [
